...
export function resolverEstadoNotificacion(estado: number | string | null | undefined): string {
...
function tieneNumeroTeu(rowData: { numEnvioTeu?: string | number | null }): boolean {
...
export function botonesPorEstadoNotificacion(
  estadoString: string,
  rowData: { numEnvioTeu?: string | number | null }
